...
class MatrixOneFormatted
{
   static void Main(String[] args)
   {
      ...
      for(i = 0;i < 3;i++)
      {
         for(j = 0;j < 4;j++)
         {
            Console.Write(String.Format("{0:0.00}",matrixA[i,j]) + " ");
         }
         Console.WriteLine();
      }
      ...
      for(i = 0;i < 3;i++)
      {
         for(j = 0;j < 4;j++)
         {
            Console.Write(String.Format("{0:0.00}",matrixB[i,j]) + " ");
         }
         Console.WriteLine();
      }
      ...
      for(i = 0;i < 3;i++)
      {
         for(j = 0;j < 4;j++)
         {
            Console.Write(String.Format("{0:0.00}",matrixSum[i,j]) + " ");
         }
         Console.WriteLine();
      }
   }
